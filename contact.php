...
<div id="page-wrapper" data-wow-delay=".5s" >
    <div class="row">
        <!--	Header start  -->
                            ...
                            <ul>
                                <li class="d-flex mb-4"> <i class="fas fa-map-marker-alt text-white mr-2 font-13 mt-1"></i>
                                    <div class="contact-address">
                                        ...
                                        <span class="text-secondary">Homex Real Estate(India) Inc. 127-128, B-wing, 1st Floor, Chintamani Plaza, Andheri-Kurla Road, Chakala, Opp. CineMagic Theatre. Andheri-E, Mumbai- 400099</span>

                                </li>
                                <li class="d-flex mb-4"> <i class="fas fa-phone-alt text-white mr-2 font-13 mt-1"></i>
                                    <div class="contact-address">
                                        <h5 class="text-white">Call Us</h5>
                                        <span class="d-table text-secondary">+91 9324493997</span>
                                ...
                                <li class="d-flex mb-4"> <i class="fas fa-envelope text-white mr-2 font-13 mt-1"></i>
                                    <div class="contact-address">
										...
										<span class="d-table text-secondary">helpline.homex@realestate.com</span>
