...
// Sanitize user input and initialize variables
$amount = isset($_REQUEST['amount']) ? floatval($_REQUEST['amount']) : 0;
$mon = isset($_REQUEST['month']) ? intval($_REQUEST['month']) : 0;
$int = isset($_REQUEST['interest']) ? floatval($_REQUEST['interest']) : 0;
$interest = 0;
$pay = 0;
$month = 0;

// Perform calculation if form is submitted
            ...
            <div class="container">
                ...
                <center>
                    ...
                    <tr class="text-center">
                        ...
                        <td><b><?php echo $amount + $interest; ?></b></td>
                    </tr>
                    <tr class="text-center">
                        <td><b>Pay Per Month (EMI)</b></td>
                        <td><b><?php echo ($amount + $interest) / $mon; ?></b></td>
                    </tr>
                    </tbody>
                </table>
            </center>
