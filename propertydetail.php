                            ...
                            <div class="row">
                                <div class="col-md-12">
                                    <div id="single-property"
                                        ...
                                        <!-- Slide 1-->
                                            <div class="ls-slide"
                                                data-ls="duration:3000; transition2d:5; kenburnszoom:in; kenburnsscale:1.2;">
                                ...
                                <div class="row mb-4">
                                    <div class="col-md-6">
                                        ...
                                        <br>
                                        <div class="bg-primary d-none d-table px-3 py-2 rounded text-white text-capitalize">
                                            <?php echo $row['status']; ?>
                                        </div>
                                        <br>
                                        <?php
if ($row['status'] == "Sold Out") {
    echo '<button id="paymentButton" type="button" class="btn btn-outline-primary" disabled>Sold Out</button>';
} else {
    echo '<a href="purchase.php?pid='.$row['pid'] .'" class="btn btn-outline-primary">Purchase</a>';
}
?>
                                            ...
                                            <div class="row">
                                                <div class="col-md-5">
                                                    <div class="row">
                                                        ...
                                                        <div class="col-md-12">
                                                            <button type="submit" id="send" value="submit" class="btn btn-primary">Contact owner Now</button>
                                                        </div>
                                                    </div>
                                                </div>
                                                <div class="col-md-7">
                        ...
                        <div class="col-lg-4">
                            <h4
                                class="double-down-line-left text-secondary position-relative pb-4 mb-4 mt-md-50 dis-none">
                            </h4>
                            <form method="post" action="property_request_form.php">
                                <div class="row">
                                    <div class="col-md-12">
                                        <div class="form-group">
                                            <input type="text" class="form-control" placeholder="Enter Name" hidden>
                                        </div>
                                    </div>
                                    <div class="col-md-12">
                                        <div class="form-group">
                                            <input type="text" class="form-control" placeholder="Enter Email" hidden>
                                        </div>
                                    </div>
                                    <div class="col-md-12">
                                        <div class="form-group">
                                            <input type="text" class="form-control" placeholder="Enter Phone" hidden>
                                        </div>
                                    </div>
                                    <div class="col-md-12">
                                        <div class="form-group">
                                    ...
                                    <div class="col-md-12">
                                        <div class="form-group mt-4">
                                            <button type="submit" class="btn btn-primary w-100">Contact Ownner</button>
                                        </div>
                                    </div>
                                </div>
                            </form>
