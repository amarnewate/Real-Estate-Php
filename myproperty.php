                    ...
                    <table class="items-list col-lg-12" style="border-collapse:inherit;">
                        <thead>
                            <tr class="bg-primary">
                                ...
                                <th class="text-white font-weight-bolder">Status Update </th>
                        ...
                        <tbody>
                            ...
                            while ($row = mysqli_fetch_array($query)) {
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <button class='action-button btn btn-primary' data-property-id='<?php echo $row["pid"]; ?>'
                                            data-current-status='<?php echo $row["status"]; ?>'
                                            onclick='updateStatus(this)'>
                                            <?php echo ($row["status"] === "Available" ? "Available" : "Sold Out"); ?>
                                        </button>
                                    </td>
