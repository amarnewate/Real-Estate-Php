            ...
            <div class="col-lg-8">
                <div class="row">
                    ...
                    if (isset($_REQUEST['filter'])) {
                        ...
                        $location = $_REQUEST['location']; // Now getting location instead of city
                        ...
                        // Construct SQL query with combined city or state filter
                        $sql = "SELECT property.*, user.uname FROM property JOIN user ON property.uid = user.uid WHERE property.type='{$type}' AND property.stype='{$stype}' AND (property.city LIKE '%{$location}%' OR property.state LIKE '%{$location}%')";
            ...
            <!--    <div class="col-md-12">
                    ...
                    <div class="col-lg-4">
                        <div class="sidebar-widget">
                            <h4 class="double-down-line-left text-secondary position-relative pb-4 my-4" float-right>Instalment Calculator</h4>
